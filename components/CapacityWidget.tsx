...
const CapacityWidget: React.FC<CapacityWidgetProps> = ({ current, max, className = 'w-48' }) => {
  ...
  return (
    <div className={`flex flex-col bg-zinc-100 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 p-2 rounded-xl ${className} transition-colors duration-300`}>
