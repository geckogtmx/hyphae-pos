...
import { OrderState, OrderAction, OrderContextType, OrderItem, SavedOrder, LoyaltyProfile, LoyaltyTransaction } from '../types';
import { LOYALTY_PROFILES, LOYALTY_TIERS, SYSTEM_CONFIG, LOYALTY_TRANSACTIONS, LOYALTY_CARDS } from '../data/mock_data';
...
const orderReducer = (state: OrderState, action: OrderAction): OrderState => {
  switch (action.type) {
    ...
    case 'CREATE_ORDER': {
      ...
      // New Order ID
      const newOrderId = (100 + state.activeOrders.length + state.completedOrders.length + 1).toString();
