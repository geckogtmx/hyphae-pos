...
import { CreditCard, Banknote, ArrowRightLeft, Split, X, DollarSign, List, Edit, Delete, PencilLine, Trash2, Plus, Coins } from 'lucide-react';
        ...
        <div className="flex flex-col h-full animate-in slide-in-from-right duration-300">
            ...
            <div className="flex space-x-6 shrink-0 p-4 bg-zinc-50 dark:bg-zinc-950 pb-[calc(1rem+env(safe-area-inset-bottom))]">
                ...
                <button onClick={() => {
                    ...
                    else if (isRefund) { setStep('METHOD_SELECT'); resetStandardState(); }
                    else { setStep('METHOD_SELECT'); resetStandardState(); }
                }} className={`flex-[2] h-20 rounded-2xl font-bold uppercase text-zinc-950 transition-colors shadow-xl text-xl tracking-widest ${isRefund ? 'bg-red-500 hover:bg-red-400' : 'bg-lime-500 hover:bg-lime-400'}`}>{isZeroBalance ? 'Update Order' : isRefund ? 'Process Refund' : 'Continue to Payment'}</button>
            </div>
        </div>
    );
        ...
        <div className="grid grid-cols-2 gap-12 h-full p-8 animate-in slide-in-from-right duration-200">
            ...
            <div className="flex flex-col justify-center">
                ...
                <div className="mt-8 w-full flex flex-col gap-4">
                    ...
                    <button onClick={() => { setStep('METHOD_SELECT'); resetStandardState(); }} className="w-full h-16 rounded-xl bg-transparent hover:bg-zinc-100 dark:hover:bg-zinc-800 text-zinc-400 hover:text-zinc-900 dark:hover:text-zinc-200 font-bold uppercase tracking-wider transition-colors">
                        Back to Methods
                    </button>
                </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-12 h-full p-8 animate-in slide-in-from-right duration-200">
                ...
                <div className="flex flex-col h-full">
                    ...
                    <div className="flex gap-4 h-20">
                        <button onClick={() => { setStep('METHOD_SELECT'); resetStandardState(); }} className="w-1/3 bg-zinc-100 dark:bg-zinc-800 rounded-2xl font-bold uppercase text-zinc-500 dark:text-zinc-400 hover:bg-zinc-200 dark:hover:bg-zinc-700 transition-colors">Cancel</button>
                        <button
            ...
            <div className="relative bg-zinc-50 dark:bg-zinc-900 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 w-[95%] h-[90vh] rounded-[2rem] shadow-2xl flex flex-col overflow-hidden transition-colors duration-300">
                ...
                {step === 'METHOD_SELECT' && (
                    <div className="h-24 border-t border-zinc-200 dark:border-zinc-800 bg-zinc-50 dark:bg-zinc-950 flex items-center justify-between px-8 shrink-0">
                        <button onClick={() => { setStep('ORDER_REVIEW'); resetStandardState(); }} className="text-sm font-bold text-zinc-500 hover:text-zinc-900 dark:hover:text-white underline uppercase tracking-wider">Back to Review</button>
